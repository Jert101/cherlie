      ...
      <div className="bg-purple-900/95 backdrop-blur-md rounded-2xl border-2 border-pink-500/30 p-6 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <select
              value={formData.type}
              onChange={(e) => setFormData({ ...formData, type: e.target.value as 'message' | 'audio' | 'image' })}
          ...
          <div>
            <label className="block text-purple-200 mb-2">
              {formData.type === 'message' ? 'Message' : formData.type === 'audio' ? 'Audio URL' : 'Image URL'}
            </label>
